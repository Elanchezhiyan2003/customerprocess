...
const About = () => {
      ...
      <div className="flex flex-col   md:flex-row md:space-x-6">
        ...
        <div className="flex-1 p-6">
          <img
            src={Home}
            alt="Home"
            className="object-contain my-4 h-12 rounded-lg"
          />
          <div className="mb-6">
        ...
        {/* Right Section: Links */}
        <div className="flex flex-wrap justify-between md:justify-start md:space-x-12">
          {/* Column 1 */}
          <div className="p-4">
  <div className="flex flex-col space-y-2">
    ...
    <a href="#" className="text-gray-600 hover:text-blue-500">Contact</a>
      ...
      {/* Footer Section */}
      <div className="mt-12 flex flex-col md:flex-row md:justify-between items-center text-center gap-4">
