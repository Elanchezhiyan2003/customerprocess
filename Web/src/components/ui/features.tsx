...
const features = () => {
  return (
    <div className=' xl:container xl:mx-auto'>
      <div className='py-4'>
      <h1 className='flex justify-evenly text-5xl'>Our unique features</h1>
      <p className='flex justify-evenly mt-4 md:mt-10 text-lg md:text-xl px-64 text-center' >powerful natural language processing capabilities, 
        that can understand and respond to customer inquries 
        in real-time & improve customer satisfication.</p>
    </div>
    <div className='px-28 py-4'>
    <div className="flexbox flex justify-evenly gap-5 px-4">
      <div className='w-60 h-auto bg-gray-100  rounded-lg space-y-4 ' >
      ...
      <div className='w-60 h-auto bg-gray-600  bg-opacity-5 rounded-lg space-y-4 ' >
        <h1 className='flex px-1 mt-4 md:mt-10 text-lg md:text-xl font-semibold'>Enterprise level super security grade</h1>
        <p className=' flex px-1 mt-4 md:mt-10 text-left'>Start maximising your company results today and speed up all your workflows processes.</p>
        <a href="" className='px-1 font-bold underline'>Learn more </a>
        <img src={Box2} className='w-60 h-32 p-2 rounded-2xl object-cover rounded-sm ' alt="" />
      </div>
      <div className='w-60 h-auto bg-gray-600  bg-opacity-5 rounded-lg space-y-4 ' >
        <h1 className='flex px-1 mt-4 md:mt-10 text-lg md:text-xl font-semibold'>Enterprise level super security grade</h1>
        <p className=' flex px-1 mt-4 md:mt-10 text-left'>Start maximising your company results today and speed up all your workflows processes.</p>
      ...
      <div className='flex '>
        <div className='py-20 space-y-7'>
          ...
          <div className='flex'>
            ...
            <div className='w-60'>
            <>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 w-8 h-8 m-4 p-1 bg-slate-800 bg-opacity-5 rounded-lg object-cover">
          ...
          <div className='px-7 pl-4'>
            <img className='w-auto h-auto  max-w-sm object-contain' src={Estimate} alt="" />
          </div>
      </div>
    </div>
    <div className='compliant m-32'>
      <div className='flex '>
      <div className='px-7 pl-4'>
            <img className='w-auto  max-w-sm h-auto object-contain' src={Compliant} alt="" />
          </div>
        <div className='py-20 space-y-7'>
          ...
          <div className='flex'>
            ...
            <div className='w-60'>
            <><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 size-6 w-8 h-8 m-4 p-1 bg-slate-800 bg-opacity-5 rounded-lg object-cover">
    ...
    <div className='native m-32'>
      <div className='flex '>
        <div className='py-20 space-y-7'>
          <h3 className='font-semibold text-3xl'>Native data</h3>
          ...
          <div className='flex'>
            ...
            <div className='w-60'>
            <>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 size-6 w-8 h-8 m-4 p-1 bg-slate-800 bg-opacity-5 rounded-lg object-cover">
        ...
        <div className='px-7 pl-4'>
            <img className='w-auto h-auto  max-w-sm object-contain' src={Native} alt="" />
          </div>     
      </div>
    </div>
